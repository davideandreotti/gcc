...
func (hs *clientHandshakeStateTLS13) sendClientCertificate() error {
	...
	certMsg.delegatedCredential = hs.certReq.supportDelegatedCredential && len(cert.DelegatedCredential) > 0 // DelegatedCredentials
	...
	var sigAlgorithm SignatureScheme                                     // DelegatedCredentials
	suppSigAlgo := hs.certReq.supportedSignatureAlgorithms               // DelegatedCredentials
	sigAlgorithm, err = selectSignatureScheme(c.vers, cert, suppSigAlgo) // DelegatedCredentials
	if err != nil {
